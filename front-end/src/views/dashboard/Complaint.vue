...
<template>
  <div class="complaint">
    ...
    <form class="complaint__form" @submit.prevent="submitForm">
      ...
      <TheInput type="textarea" icon-name="message-check" v-model="message" :error-message="messageError"
        label="ثبت انتقاد یا پیشنهاد" placeholder="هرچه می خواهد دل تنگت بگو :)" />
      <TheButton type="submit" label="ثبت انتقاد یا پیشنهاد" class="complaint__button" />
    </form>
  </div>
</template>
